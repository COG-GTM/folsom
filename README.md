...
This project requires Java 8 or higher. The codebase uses Java 8 language features
including lambda expressions, method references, streams, and the `CompletionStage` API.
